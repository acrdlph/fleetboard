#!/usr/bin/env python3
"""fleetboard integration tests — exercise the REAL pipeline against controlled
...
class TestCollectPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # point fleetboard at the fixtures; neutralize live-system inputs
