...
| **Tests** | 773 · characterization 5,656 cases (18 sections), unchanged — none of step 7 touches `/api/state` · the QR encoder additionally checked against Apple's `CIQRCodeGenerator` module for module and decoded back by Vision (`tests/qr_ref.py`) |
